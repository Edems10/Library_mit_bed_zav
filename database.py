...
if login_result[0]:
    ...
    if user.role == Roles.Librarian.name:
        ...
        print(current_user.unban_user(mongo_client, "63619fb5b63ff822f52c95b2")[1])
        ...
        print(current_user.edit_user(mongo_client, user_current_id, "test_of_changes 3", "data 3", "CZ")[1])
