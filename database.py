...
if login_result[0]:
    ...
    if user.role == Roles.Librarian.name:
        ...
        #print(current_user.ban_user(mongo_client, "6367e8644a2ed21f9afc5e8e")[1])
        print(current_user.unban_user(mongo_client, "6367e8644a2ed21f9afc5e8e")[1])
        print(current_user.accept_user_changes(mongo_client, "6367e8644a2ed21f9afc5e8e")[1])
        #print(current_user.decline_user_changes(mongo_client, "6367e8644a2ed21f9afc5e8e")[1])
        print(current_user.get_all_users_with_stashed_changes(mongo_client))
        print(current_user.verified_user(mongo_client, "6367e8644a2ed21f9afc5e8e")[1])
        ...
        print(current_user.borrow_book(mongo_client, "Gladiator")[1])
        print(get_all_borrowed_books_from_user(mongo_client, user_current_id))
        print(current_user.return_book(mongo_client, "Gladiator")[1])
